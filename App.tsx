...
const SECTION_PATH_MAP: Record<AppSection, string> = {
  [AppSection.HOME]: '/',
  [AppSection.JADE_APPRAISAL]: '/jda',
  [AppSection.TRY_ON_CLOTHES]: '/clt',
  [AppSection.ADVANCED_TRY_ON]: '/ato',
  [AppSection.TRY_ON_ACCESSORIES]: '/acc',
  [AppSection.HAIRSTYLE]: '/hrs',
  [AppSection.MAKEUP]: '/mkp',
  [AppSection.BEAUTY_SCORE]: '/bts',
  [AppSection.COUPLE_FACE]: '/cpf',
  [AppSection.TONGUE_DIAGNOSIS]: '/tng',
  [AppSection.FACE_COLOR]: '/fcl',
  [AppSection.FACE_READING]: '/frd',
  [AppSection.FENG_SHUI]: '/fsh',
  [AppSection.CALENDAR]: '/cal',
  [AppSection.LICENSE_PLATE]: '/lpt',
  [AppSection.MBTI_TEST]: '/mbt',
  [AppSection.DEPRESSION_TEST]: '/dep',
  [AppSection.MARRIAGE_ANALYSIS]: '/mrg',
  [AppSection.WEALTH_ANALYSIS]: '/wth',
  [AppSection.AI_EYE_DIAGNOSIS]: '/eye',
  [AppSection.EQ_TEST]: '/eqt',
  [AppSection.IQ_TEST]: '/iqt',
  [AppSection.BIG_FIVE]: '/bgf',
  [AppSection.ZI_WEI_DOU_SHU]: '/zwd',
  [AppSection.APP_DOWNLOAD]: '/dld',
  [AppSection.LINKTREE]: '/tre',
  [AppSection.ADMIN]: '/adm',
};
